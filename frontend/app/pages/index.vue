  ...
  <div class="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(79,70,229,0.18),_transparent_30%),linear-gradient(135deg,_#f8fafc_0%,_#eef2ff_100%)] p-4 sm:p-6 lg:p-10 flex items-center justify-center">
    <div class="w-full max-w-5xl overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-[0_25px_80px_-20px_rgba(15,23,42,0.35)]">
      <div class="grid lg:grid-cols-[1.05fr_0.95fr]">
        <div class="flex flex-col justify-between bg-slate-900 p-8 text-white sm:p-10 lg:p-12">
          <div>
            <div class="mb-6 inline-flex items-center rounded-full border border-white/15 bg-white/10 px-3.5 py-1 text-sm text-slate-200">
              <span class="mr-2 text-lg">🛒</span>
              Sistem Kasir Toko Sejahtra
            </div>
            <h1 class="text-3xl font-bold leading-tight tracking-tight">Kelola transaksi kasir dengan cepat, akurat, dan aman.</h1>
            <p class="mt-4 max-w-md text-sm leading-6 text-slate-300">
              Pantau stok barang real-time, proses pembayaran multi-metode, dan arsip riwayat transaksi dari dashboard profesional.
            </p>
          </div>

          <div class="mt-8 rounded-2xl border border-white/10 bg-white/10 p-5 backdrop-blur-sm">
            <p class="text-sm font-semibold text-slate-100">Fitur Utama</p>
            <ul class="mt-3 space-y-2 text-sm text-slate-300">
              ...
              <li class="flex items-center gap-2">
                <span class="text-emerald-400">✓</span> Pembatalan transaksi aman dengan restock otomatis
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="p-8 sm:p-10 lg:p-12 flex flex-col justify-center">
          <div class="mb-8">
            <h2 class="text-2xl font-bold text-slate-900">Masuk ke Sistem Kasir</h2>
            <p class="mt-1.5 text-sm text-slate-500">Gunakan akun terdaftar untuk mulai transaksi.</p>
          </div>
